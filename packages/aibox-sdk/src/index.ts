...
export {
  AiboxError, isAiboxError, hasCode, isPermissionDenied, isTransient,
  normalizeError, attempt, withFallback,
} from './errors';
export type { AiboxErrorCode, KnownAiboxErrorCode, AiboxResult } from './errors';

export {
  isAvailable, allAvailable, ifAvailable, requireAvailable,
  registeredNamespaces, explainAccess, probe,
} from './capabilities';
...
export {
  tabsAreRendered, searchIsRendered, tabsState, selectTab, setTabBadge,
  sceneState, setTitle, setCloseConfirmation, haptic,
} from './shell';
