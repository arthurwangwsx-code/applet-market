  ...
  React.useEffect(() => {
    ...
    const boot = async () => {
      ...
      poll = setInterval(() => {
        ...
        if (isLibraryDenied()) { clearInterval(poll); poll = null; return }
        refresh()
