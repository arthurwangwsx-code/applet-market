...
export function Row({ icon, iconColor, title, subtitle, detail, accessory, onClick, danger, last }: RowProps) {
  ...
  return (
    ...
    >
      ...
      {detail !== undefined && detail !== null ? (
        <span className="news-mono" style={{ fontSize: 15, color: C.muted, flex: '0 0 auto' }}>
          {detail}
        </span>
      ) : null}
      {accessory}
 ...
 */
export function useIncremental<T>(items: T[], step = 30) {
