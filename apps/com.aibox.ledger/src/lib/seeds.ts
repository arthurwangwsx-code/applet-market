...
/** 资产页的账户分组顺序（空组不渲染）。 */
export const ACCOUNT_KIND_ORDER = ['cash', 'debit', 'ewallet', 'prepaid', 'credit', 'investment'] as const
...
/** 按 locale 取种子名。 */
export function seedName(entry: { en: string; zh: string }, locale: string): string {
