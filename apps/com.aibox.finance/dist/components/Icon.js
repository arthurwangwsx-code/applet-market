...
function ringed(glyph, filled) {
    return filled ? (_jsxs(_Fragment, { children: [_jsx("circle", { cx: "12", cy: "12", r: "9.2", fill: "currentColor" }), _jsx("g", { fill: "none", stroke: "var(--fin-surface)", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: glyph })] })) : (_jsxs(_Fragment, { children: [_jsx("circle", { cx: "12", cy: "12", r: "9.2", ...STROKE }), _jsx("g", { ...STROKE, children: glyph })] }));
}
