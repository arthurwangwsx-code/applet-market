...
import { NEWS_TOPICS } from '../types.js'
import type { FeedKind, NewsTopic } from '../types.js'
...
export const FEED_KINDS = ['rss', 'atom', 'rsshub', 'api'] as const satisfies readonly FeedKind[]

export function topicKey(topic: NewsTopic | null) {
  return topic ? `news.topic.${topic}` : 'news.topic.all'
}

const gnews = (section: string) =>
  section
...
export const SEEDS = [
  ...
  {
    title: 'BBC 中文网',
    endpoint: 'https://www.bbc.co.uk/zhongwen/simp/index.xml',
    kind: 'rss',
    topic: 'world',
    enabled: true,
  },
  ...
  {
    title: '德国之声中文',
    endpoint: 'https://rss.dw.com/rdf/rss-chi-all',
    kind: 'rss',
    topic: 'world',
    enabled: false,
  },
  ...
  {
    title: 'The Guardian',
    endpoint: 'https://www.theguardian.com/international/rss',
    kind: 'rss',
    topic: 'world',
    enabled: false,
  },
  ...
  {
    title: '新浪科技',
    endpoint: 'https://rss.sina.com.cn/tech/rollnews.xml',
    kind: 'rss',
    topic: 'tech',
    enabled: false,
  },
  ...
  {
    title: '阮一峰',
    endpoint: 'https://www.ruanyifeng.com/blog/atom.xml',
    kind: 'atom',
    topic: 'tech',
    enabled: false,
  },
  ...
  {
    title: 'MarketWatch',
    endpoint: 'https://feeds.marketwatch.com/marketwatch/topstories/',
    kind: 'rss',
    topic: 'business',
    enabled: false,
  },
  {
    title: 'Forbes',
    endpoint: 'https://www.forbes.com/business/feed/',
    kind: 'rss',
    topic: 'business',
    enabled: false,
  },
  ...
  {
    title: '科学美国人',
    endpoint: 'https://rss.sciam.com/ScientificAmerican-Global',
    kind: 'rss',
    topic: 'science',
    enabled: false,
  },
  ...
  {
    title: 'NASA',
    endpoint: 'https://www.nasa.gov/rss/dyn/breaking_news.rss',
    kind: 'rss',
    topic: 'science',
    enabled: false,
  },
  ...
  {
    title: 'BBC Sport',
    endpoint: 'https://feeds.bbci.co.uk/sport/rss.xml',
    kind: 'rss',
    topic: 'sports',
    enabled: false,
  },
  {
    ...
    endpoint: 'https://www.theguardian.com/sport/rss',
    kind: 'rss',
    topic: 'sports',
    enabled: false,
  },
  ...
  {
    title: 'NYT Health',
    endpoint: 'https://rss.nytimes.com/services/xml/rss/nyt/Health.xml',
    kind: 'rss',
    topic: 'health',
    enabled: false,
  },
  ...
  {
    title: 'NYT Arts',
    endpoint: 'https://rss.nytimes.com/services/xml/rss/nyt/Arts.xml',
    kind: 'rss',
    topic: 'culture',
    enabled: false,
  },
  {
    title: 'Guardian Culture',
    endpoint: 'https://www.theguardian.com/culture/rss',
    kind: 'rss',
    topic: 'culture',
    enabled: false,
  },
...
] satisfies Array<{ title: string; endpoint: string; kind: FeedKind; topic: NewsTopic; enabled: boolean }>
