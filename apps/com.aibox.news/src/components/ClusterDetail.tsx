...
import type { ArticleMenuFactory } from './ArticleList.js'
import { SectionHeader } from './primitives.js'
import { C, SPACE } from './theme.js'
import type { ActionSheetItem } from './primitives.js'
import type { NewsArticle, NewsContext, NewsRoute } from '../types.js'

type ClusterRoute = Extract<NewsRoute, { name: 'cluster' }>
export default function ClusterDetail({ ctx, cluster }: { ctx: NewsContext; cluster: ClusterRoute }) {
  ...
  const menuFor = React.useCallback<ArticleMenuFactory>(
    (article) => {
