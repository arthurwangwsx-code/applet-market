...
export default function Icon({ name, size = 20, color, style, }) {
    ...
    return (_jsxs("svg", { viewBox: "0 0 24 24", width: size, height: size, "aria-hidden": "true", style: { display: 'block', color, flex: '0 0 auto', ...style }, children: [stroke ? _jsx("path", { d: stroke, ...S }) : null, fill ? _jsx("path", { d: fill, ...F }) : null] }));
}
