...
export default function App() {
    ...
    return (_jsxs("div", { style: {
            ...
            paddingBottom: 'env(safe-area-inset-bottom)',
                            ...
                            color: palette.ink,
                        } }), tab === 'search' && capabilities.picker && capabilities.ocr ? (_jsx("button", { type: "button", onClick: () => setPhotoOpen(true), style: {
                            border: 'none',
                            background: 'transparent',
                            color: palette.accent,
                            cursor: 'pointer',
                            padding: 8,
                        }, "aria-label": t('photoLookup'), children: _jsx(Icon, { name: "viewfinder", size: 18 }) })) : null] })) : null, _jsxs("main", { style: { flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch' }, children: [tab === 'search' ? (_jsx(SearchPage, { palette: palette, t: t, lang: lang, store: store, query: searchQuery, aiAvailable: aiAvailable, surface: scene?.effective ?? null, onOpenWord: openWord, onOpenTranslation: (id) => setRoute({ kind: 'translation', id }), onTranslateSentence: goTranslate, onOpenReview: () => setRoute({ kind: 'review' }) })) : null, tab === 'translate' ? (_jsx(TranslatePage, { palette: palette, t: t, store: store, pending: pendingTranslate, aiAvailable: aiAvailable, onPendingConsumed: () => setPendingTranslate(null) })) : null, tab === 'vocab' ? (_jsx(VocabPage, { palette: palette, t: t, lang: lang, store: store, query: vocabQuery, onOpenWord: openWord, onOpenReview: () => setRoute({ kind: 'review' }) })) : null] }), !tabs.rendered ? (_jsx("nav", { style: {
                    display: 'flex',
