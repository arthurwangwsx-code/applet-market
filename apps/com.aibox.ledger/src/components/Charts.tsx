...
import type { ReportBucket } from '../types.js'

export const DONUT_LIMIT = 8
export const LEGEND_LIMIT = 6

export function bucketColor(bucket: ReportBucket, index: number): string {
...
/** 环形图（SectorMark 等价）。 */
export function DonutChart({ buckets, size = 150 }: { buckets: ReportBucket[]; size?: number }) {
...
/** 环形的固定搭档：图例，取前 6 项。 */
export function ChartLegend({ buckets, currency }: { buckets: ReportBucket[]; currency: string }) {
