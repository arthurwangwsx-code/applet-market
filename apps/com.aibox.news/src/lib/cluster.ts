...
export function vectorize(text: string): Map<string, number> | null {
  ...
  for (const [key, value] of counts) counts.set(key, value / norm)
  return counts
}
