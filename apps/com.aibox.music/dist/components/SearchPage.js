...
export default function SearchPage({ ctx, query, onQueryChange, searchRendered }) {
    ...
    return (_jsxs("div", { className: "mu-scroll", children: [!searchRendered ? (_jsx("div", { style: { padding: `${SPACE.s2}px ${SPACE.s4}px 0` }, children: _jsx("input", { value: query, placeholder: t('search.placeholder'), autoCorrect: "off", autoCapitalize: "none", onChange: (event) => onQueryChange(event.target.value), onKeyDown: (event) => { if (event.key === 'Enter')
                        submit(); }, style: {
