...
export type AppletTemplate = 'vanilla' | 'react' | 'game-canvas-lite' | 'game-2d-phaser' | 'game-2d-pixi' | 'game-3d-babylon' | 'game-ai-turnbased';
...
export interface AppletManifestDeclaration {
    ...
    presentation?: {
        default?: AppletSurface;
        surfaces?: AppletSurface[];
    };
 ...
 */
export declare function defineManifest<T extends AppletManifestDeclaration>(manifest: T): T;
