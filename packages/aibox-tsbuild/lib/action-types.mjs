...
// 由 manifest 的 actions 生成 TS 类型（原住 aibox-vite/lib/manifest-plugin.mjs，2026-08-06 随管线收敛搬来）。
//  manifest-plugin.mjs
...
export function renderActionTypes(manifest) {
  ...
  const lines = [BANNER, "import '@aibox/applet-sdk';", '', "declare module '@aibox/applet-sdk' {", '  interface AppletActionMap {'];
  if (actions.length === 0) {
...
/**
 * Vite 插件：构建开始时读 manifest、校验、生成 action 类型。
